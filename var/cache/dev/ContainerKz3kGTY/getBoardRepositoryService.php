...
class getBoardRepositoryService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/Repository/BoardRepository.php';

        return $container->privates['App\\Repository\\BoardRepository'] = new \App\Repository\BoardRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
